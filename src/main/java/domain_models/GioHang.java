...
public class GioHang {
    ...
    public boolean equals(Object o) {
        ...
        if (id != null ? !id.equals(gioHang.id) : gioHang.id != null) return false;
        if (idKh != null ? !idKh.equals(gioHang.idKh) : gioHang.idKh != null) return false;
        if (idNv != null ? !idNv.equals(gioHang.idNv) : gioHang.idNv != null) return false;
        if (ma != null ? !ma.equals(gioHang.ma) : gioHang.ma != null) return false;
        if (ngayTao != null ? !ngayTao.equals(gioHang.ngayTao) : gioHang.ngayTao != null) return false;
        if (ngayThanhToan != null ? !ngayThanhToan.equals(gioHang.ngayThanhToan) : gioHang.ngayThanhToan != null)
            return false;
        if (tenNguoiNhan != null ? !tenNguoiNhan.equals(gioHang.tenNguoiNhan) : gioHang.tenNguoiNhan != null)
            return false;
        if (diaChi != null ? !diaChi.equals(gioHang.diaChi) : gioHang.diaChi != null) return false;
        if (sdt != null ? !sdt.equals(gioHang.sdt) : gioHang.sdt != null) return false;
        if (tinhTrang != null ? !tinhTrang.equals(gioHang.tinhTrang) : gioHang.tinhTrang != null) return false;
